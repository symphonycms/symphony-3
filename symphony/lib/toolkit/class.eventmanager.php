<?php
    ...
    Class EventManager extends Manager{
        ...
        function &create($name, $environment=NULL){
	        ...
	        if(!is_file($path)){
		        trigger_error(__('Could not find Event <code>%s</code>. If the Event was provided by an Extension, ensure that it is installed, and enabled.', array($name)), E_USER_ERROR);
		        return false;
	        }
